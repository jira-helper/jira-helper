...
This page is a map of everything Jira Helper can do. Each item links to the full guide.
...
- **[Swimlane histogram](/docs/features/board-visualization/swimlane-histogram)** — column distribution bars per swimlane

### Card information

Extra badges and context on cards
