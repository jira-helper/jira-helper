...
4. Выберите колонки, в которых должны отображаться бейджи связей, в секции **Column Selection**.
5. При необходимости включите **Show links in backlog**, чтобы связи отображались и на карточках бэклога.
6. Нажмите **Add Link Configuration** и настройте правило:
...
7. При необходимости добавьте несколько конфигураций для разных типов связей.
