...
export const JiraUserSelect: React.FC<JiraUserSelectProps> = ({
  ...
  const handleSelect = useCallback(
    (value: unknown, option: Record<string, unknown>) => {
      const userName = (option?.key || option?.value || (option?.props as Record<string, unknown> | undefined)?.key || (option?.props as Record<string, unknown> | undefined)?.value || value) as string | undefined;
