...
import { ToggleIgnoredStatus } from './actions/toggleIgnoredStatus';
...
export const StatusCategorySettings = () => {
  ...
  const mapStatusCategoryToColor = (statusCategory: 'new' | 'indeterminate' | 'done') => {
          ...
          <React.Fragment key={statusId}>
            ...
            <span
              style={{
                ...
                width: '1em',
                height: '1em',
                backgroundColor: mapStatusCategoryToColor(status.statusCategory),
                marginRight: '0.5em',
              }}
            />
            <Checkbox
              ...
              onChange={() => {
                ToggleIgnoredStatus(statusIdNumber);
              }}
            >
              {texts.ignoreStatus}
            </Checkbox>
